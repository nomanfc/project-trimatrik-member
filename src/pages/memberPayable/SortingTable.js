...
import { MemberPayableColumnData } from "../../components/TableColumns/ColumnData";
...
const Table = (props) => {
  ...
  const headerColumn = useMemo(() => MemberPayableColumnData, []);
            ...
            {page?.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <s.td>
                    <s.actionCon>
                      <Tooltip title="Submit Payment Proof" aria-label="Submit">
                        <IconButton onClick={props.handleApproveModal({row})}>
                          <PublishIcon style={{ color: mainThemeColor }} />
                        </IconButton>
                      </Tooltip>
                    </s.actionCon>
                  </s.td>
