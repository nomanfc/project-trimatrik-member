...
import { AdminColumnData } from "../../components/TableColumns/ColumnData";
...
const Table = (props) => {
  ...
  const headerColumn = useMemo(() => AdminColumnData, []);
                  ...
                  <s.td>
                    <s.actionCon>
                      {row.original.is_active === 1 ? (
                        <Tooltip title="Deactivate" aria-label="details">
                          <IconButton
                            onClick={props.handleOpenDeActivateAdminModal({
                              row,
                            })}
                          >
                        ...
                        <Tooltip title="Activate" aria-label="details">
                          <IconButton
                            onClick={props.handleOpenActivateAdminModal({
                              row,
                            })}
                          >
                            <CheckCircleIcon
