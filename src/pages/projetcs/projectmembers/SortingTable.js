...
import { ProjectMemberColumnData } from "../../../components/TableColumns/ColumnData";
...
const Table = (props) => {
  ...
  const headerColumn = useMemo(() => ProjectMemberColumnData, []);
            ...
            {page?.map((row, index) => {
              ...
              return (
                <s.tr {...row.getRowProps()} key={index}>
                  ...
                  <s.td>
                    <s.actionCon>
                      {/* <Tooltip title="Project Members" aria-label="details">
                        <IconButton
                          onClick={() =>
                            router.push({
                              pathname: "/projects/addprojectmembers",
                      ...
                      <Tooltip title="Edit Share Amount" aria-label="edit">
                        <IconButton onClick={props.handleEditModal({ row })}>
